...
document.getElementById(`${package.name}About`).onclick = function() { package.createWindow(`<div id="%window%Body" class="windowBody blur" style="text-align:center;"><img src="logo.webp" style="float:left;margin-right:15px;"><h1 style="float:right;margin-top:20px;margin-left:45px;margin-right:45px;">auroraOS</h1> <p><strong>Build</strong> 101</p> <p><strong>Version</strong> 5.0</p> <p>()</p> <h2>Open-source licenses</h2><a href="https://jquery.com/">jQuery & jQueryUI - The jQuery Foundation</a> <br><a href="https://github.com/daneden/animate.css">Animate.css - daneden</a></div>`, { titleBar: "Default", title: "About auroraOS", startingDimensions: [410, 300] }); };
